...
export default function ChartConfig(props) {
    ...
    const configArr = [
        {
            ...
            inputEle: () => (
                <InputEle
                    ...
                    onChange={(e) =>
                        setOption({ ...option, title: { ...option.title, text: e.target.value } })
                    }
                />
            ),
        },
        {
            ...
            colorEle: () => (
                <ColorEle
                    key="colorEle"
                    value={option.color}
                    onChange={(color) => setOption({ ...option, color })}
                />
            ),
        },
        {
            ...
            inputNumberEle: () => (
                <InputNumberEle
                    ...
                    onChange={(num) =>
                        setOption({
                            ...option,
                            series: option.series.map((item) => ({ ...item, barGap: num + '%' })),
                        })
                    }
                />
            ),
                    ...
                    onChange={(num) =>
                        setOption({
                            ...
                            series: option.series.map((item) => ({
                                ...item,
                                lineStyle: { ...item.lineStyle, width: num },
                            })),
                        })
                    }
                />
            ...
            pointWidth: () => (
                <InputNumberEle
                    ...
                    onChange={(num) =>
                        setOption({
                            ...option,
                            series: option.series.map((item) => ({ ...item, symbolSize: num })),
                        })
                    }
                />
            ),
    ...
    return (
        <Collapse expandIconPosition="right" className="board-collapse">
            {configArr
                .filter((item) => showPanel[type].includes(item.key))
                .map((item) => (
